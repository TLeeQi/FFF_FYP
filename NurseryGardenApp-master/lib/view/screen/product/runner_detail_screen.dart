...
class _RunnerDetailScreenState extends State<RunnerDetailScreen> {
  ...
  // Dummy data
  final List<String> runnerServiceOptions = [
    'Runners',
    'Delivery',
  ...
  void _submitForm() async{
    ...
    try{
     bool success = await Provider.of<OrderProvider>(context, listen: false)
          .storeRunnerDetail(runnerData, context);
      ...
      if (success) {
        ...
        Navigator.pushReplacementNamed(
          ...
          Routes.getOrderConfirmationRoute(
            ...
            isRunner: true, // Specify the relevant flag
            detailData: runnerData,
          ),
        );
      } else {
        EasyLoading.showToast('Failed to book runner service.');
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
        title: const Text('Runner Service'),
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Runner Service Type
                  Text('What type of runner service do you need?',
                      style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: Dimensions.FONT_SIZE_LARGE)),
                  ...
                  // Fixes
                  Text('Where is your target area?',
                      style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: Dimensions.FONT_SIZE_LARGE)),
                  const SizedBox(height: 10),
